<nav class="navbar navbar-expand bg-light w-100" style=" height: 108px;">
  <div class="container " style="margin: 20px 93px 20px 93px; width: 192px;">
    <img src="{{ ('asset/img/logo.png') }}"  class=" bg-light" style="width: 192px; height: 68px;">
    <ul class="navbar-nav" style="margin: 20px 90px 20px 93px;">
      <li class="nav-item ">
        <a class="nav-link  px-4" style=" color: #8B8B8B;" href="Beranda">Beranda</a>
      </li>
      <li class="nav-item " style=" width: 180px;">
        <a class="nav-link  px-4" style=" color: #8B8B8B;"  href="#">Gabung jadi Mitra</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link  px-4" style=" color: #8B8B8B;" href="#">Karir</a>
      </li>
      <li class="nav-item " style=" width: 196px; ">
        <a class="nav-link  px-4" style=" color: #8B8B8B;" href="#">Tentang Perusahaan</a>
      </li>
      <li class="nav-item  ">
        <a class="nav-link active  px-4" style=" color: #8B8B8B;" href="Produk">Produk</a>
      </li>
      <li class="nav-item ">
